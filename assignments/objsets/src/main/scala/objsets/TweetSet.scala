...
object GoogleVsApple {
  val google = List("android", "Android", "galaxy", "Galaxy", "nexus", "Nexus", "Siri")
  val apple = List("ios", "iOS", "iphone", "iPhone", "ipad", "iPad")

  val tweets = TweetReader.allTweets
  lazy val googleTweets: TweetSet = 
    tweets.filter( Tweet => google.exists(x => Tweet.text.contains(x)) )
  lazy val appleTweets: TweetSet = 
    tweets.filter( Tweet => apple.exists(x => Tweet.text.contains(x)) )
